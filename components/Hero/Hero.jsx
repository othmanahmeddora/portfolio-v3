    ...
    <>
      ...
      <section className="h-screen px-4 overflow-hidden relative mx-auto z-0">
        <div
          ...
          className="flex justify-center mt-10 z-50"
        >
          <Image
            height={500}
            width={500}
        ...
        <div
          ...
          className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-[20rem] leading-60 uppercase text-center font-bold z-[-1] text-primary"
        >
